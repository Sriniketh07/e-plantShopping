...
const ProductList = () => {
  ...
  const categories = {
    ...
    'Flowering Plants': [
      ...
      { id: 10, name: 'Orchid', price: 1299, image: 'https://source.unsplash.com/300x300/?orchid' },
      { id: 11, name: 'Anthurium', price: 799, image: 'https://source.unsplash.com/300x300/?anthurium' },
      { id: 12, name: 'Peace Lily', price: 599, image: 'https://source.unsplash.com/300x300/?peacelily' },
    ],
    'Succulents': [
      ...
      { id: 16, name: 'Burros Tail', price: 549, image: 'https://source.unsplash.com/300x300/?succulent' },
  ...
  return (
    <div>
      {/* Navbar */}
      <nav style={{ backgroundColor: '#2e7d32', padding: '15px', color: 'white', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: '25px', alignItems: 'center' }}>
          ...
          <div style={{ position: 'relative' }}>
            🛒 <span style={{ position: 'absolute', top: '-8px', right: '-10px', background: 'red', color: 'white', borderRadius: '50%', padding: '1px 6px', fontSize: '12px' }}>{totalQuantity}</span>
          </div>
        </div>
      </nav>

      <div style={{ padding: '30px', maxWidth: '1200px', margin: '0 auto' }}>
        <h1 style={{ textAlign: 'center', marginBottom: '40px' }}>Our Houseplants Collection</h1>
          ...
          <div key={category} style={{ marginBottom: '60px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '25px' }}>
              {categories[category].map(plant => (
                <div key={plant.id} style={{ border: '1px solid #ddd', borderRadius: '12px', padding: '15px', textAlign: 'center' }}>
                  ...
                  <button 
                    ...
                    style={{ padding: '10px 20px', backgroundColor: addedItems[plant.id] ? '#888' : '#4CAF50', color: 'white', border: 'none', borderRadius: '8px', cursor: addedItems[plant.id] ? 'not-allowed' : 'pointer' }}
                  >
